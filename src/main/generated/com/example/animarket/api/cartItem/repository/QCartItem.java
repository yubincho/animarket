package com.example.animarket.api.cartItem.repository;
...
public class QCartItem extends EntityPathBase<CartItem> {
    ...
    private static final long serialVersionUID = -921465225L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QCartItem cartItem = new QCartItem("cartItem");

    public final com.example.animarket.api.cart.repository.QCart cart;

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final com.example.animarket.api.product.repository.QProduct product;
    ...
    public QCartItem(Class<? extends CartItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.cart = inits.isInitialized("cart") ? new com.example.animarket.api.cart.repository.QCart(forProperty("cart"), inits.get("cart")) : null;
        this.product = inits.isInitialized("product") ? new com.example.animarket.api.product.repository.QProduct(forProperty("product"), inits.get("product")) : null;
    }
